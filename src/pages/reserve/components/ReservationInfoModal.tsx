        ...
        >
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <div className="rounded-xl p-4 border" style={{ backgroundColor: '#FFF4E6', borderColor: '#CBB676' }}>
      ...
      >
        ...
        >
          ...
          <div className="mb-2.5">
            <h3 className="text-sm font-bold mb-1.5 flex items-center gap-1.5" style={{ fontFamily: 'Pretendard Variable, Pretendard, Noto Sans KR, sans-serif', color: '#0C2A23' }}>
              <div className="w-5 h-5 flex items-center justify-center rounded" style={{ backgroundColor: '#CBB676' }}>
                <i className="ri-information-line text-xs" style={{ color: '#FFFFFF' }}></i>
              </div>
              예약 안내
            </h3>
            <div className="space-y-1.5">
              <div className="rounded-lg p-2 border" style={{ backgroundColor: '#FAFAFA', borderColor: '#E5E5E5' }}>
                <div className="flex items-start gap-1.5">
                  <i className="ri-user-line text-xs mt-0.5" style={{ color: '#CBB676' }}></i>
                  <div>
                    <p className="font-semibold text-xs mb-0.5" style={{ fontFamily: 'Pretendard Variable, Pretendard, Noto Sans KR, sans-serif', color: '#0C2A23' }}>
                      예약자 정보 정확히 기입
                    </p>
              ...
              <div className="rounded-lg p-2 border" style={{ backgroundColor: '#FAFAFA', borderColor: '#E5E5E5' }}>
                <div className="flex items-start gap-1.5">
                  <i className="ri-bank-card-line text-xs mt-0.5" style={{ color: '#CBB676' }}></i>
                  <div>
                    <p className="font-semibold text-xs mb-0.5" style={{ fontFamily: 'Pretendard Variable, Pretendard, Noto Sans KR, sans-serif', color: '#0C2A23' }}>
                      예약금 1인 10,000원
                    </p>
                    <p className="text-[10px] leading-relaxed" style={{ fontFamily: 'Pretendard Variable, Pretendard, Noto Sans KR, sans-serif', color: '#666666' }}>
                      입금자 성함과 예약자 성함을 일치하게 작성해주세요.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-lg p-2 border" style={{ backgroundColor: '#FAFAFA', borderColor: '#E5E5E5' }}>
                <div className="flex items-start gap-1.5">
                  <i className="ri-group-line text-xs mt-0.5" style={{ color: '#CBB676' }}></i>
                  <div>
                    <p className="font-semibold text-xs mb-0.5" style={{ fontFamily: 'Pretendard Variable, Pretendard, Noto Sans KR, sans-serif', color: '#0C2A23' }}>
                      시간대별 5테이블 한정
                    </p>
              ...
              <div className="rounded-lg p-2 border" style={{ backgroundColor: '#FAFAFA', borderColor: '#E5E5E5' }}>
                <div className="flex items-start gap-1.5">
                  <i className="ri-refresh-line text-xs mt-0.5" style={{ color: '#CBB676' }}></i>
                  <div>
                    <p className="font-semibold text-xs mb-0.5" style={{ fontFamily: 'Pretendard Variable, Pretendard, Noto Sans KR, sans-serif', color: '#0C2A23' }}>
                      취소 및 환불
                    </p>
